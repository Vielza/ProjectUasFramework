                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8 flex justify-center space-x-4">
                        ...
                        <form action="{{ route('cakes.like', $cake->id) }}" method="POST" class="flex-grow max-w-xs">
                            @csrf
                            <button type="submit" class="w-full flex justify-center items-center gap-2 px-4 py-3 rounded-lg shadow-lg bg-gradient-to-r from-green-400 to-green-600 text-white font-semibold transition transform hover:scale-105 hover:shadow-xl active:scale-95">
                        ...
                        <form action="{{ route('cakes.dislike', $cake->id) }}" method="POST" class="flex-grow max-w-xs">
                            @csrf
                            <button type="submit" class="w-full flex justify-center items-center gap-2 px-4 py-3 rounded-lg shadow-lg bg-gradient-to-r from-red-400 to-red-600 text-white font-semibold transition transform hover:scale-105 hover:shadow-xl active:scale-95">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6" viewBox="0 0 24 24">
